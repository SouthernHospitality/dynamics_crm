  ...
  module XML
    ...
    class Fault < RuntimeError
      ...
      def initialize(fault_xml)
        ...
        # REXL::Element
        @code = fault_xml.get_text("//*:Code/*:Value")
        @subcode = fault_xml.get_text("//*:Code/*:Subcode/*:Value")
        @reason = fault_xml.get_text("//*:Reason/*:Text")

        @detail = {}
        detail_fragment = fault_xml.get_elements("//*:Detail").first
        if detail_fragment
